...
def construct(formula, configuration, concatenator='/', escape_prefix='/'):
    ...
    for term in formula:
        ...
        # if there's another formula
            ...
            # concatenate current string and the result string from the new formula
...
if __name__ == "__main__":
    ...
    url = construct(config["Construction"]["url"], config["DownloadSettings"], concatenator='/', escape_prefix='/')
